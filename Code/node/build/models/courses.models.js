...
var deleteCourse = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                queryText = 'DELETE FROM Courses WHERE id = ?';
...
var getCourseStudents = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    var queryText;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                queryText = 'SELECT * FROM Students WHERE courseId = ?';
                return [4 /*yield*/, (0, dbConnection_1.default)(queryText, [id])];
