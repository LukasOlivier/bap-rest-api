...
var enrollStudent = function (studentId, courseId) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                queryText = 'UPDATE Students SET courseId = ? WHERE id = ?';
                return [4 /*yield*/, (0, dbConnection_1.default)(queryText, [courseId, studentId])];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
...
var unenrollStudent = function (studentId) { return __awaiter(void 0, void 0, void 0, function () {
    var queryText;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                queryText = 'UPDATE Students SET courseId = NULL WHERE id = ?';
