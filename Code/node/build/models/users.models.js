    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, dbConnection_1.default)(queryText, [email])];
...
var authenticateUser = function (email, password) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, exports.getUser)(email)];
            case 1:
                user = _a.sent();
                if ((0, exports.isPasswordValid)(user.password, password)) {
